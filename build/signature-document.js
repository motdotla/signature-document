...
(function(SignatureDocument){
  ...
  SignatureDocument.prototype._drawDoneConfirmation = function() {
    ...
    done_confirmation_msg.innerHTML       = "Are you sure you are done signing?";
    ...
    this.done_confirmation_yes.innerHTML  = "Yes";
    ...
    this.done_confirmation_no.innerHTML  = "No";
